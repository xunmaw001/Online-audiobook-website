        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="书籍分类" prop="shujiTypes">
                        <el-select v-model="ruleForm.shujiTypes" :disabled="ro.shujiTypes" placeholder="请选择书籍分类">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="书籍分类" prop="shujiValue">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shujiFile" label="书籍文件" prop="shujiFile">
                        <file-upload
                                tip="点击上传书籍文件"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shujiFile" label="书籍文件" prop="shujiFile">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.shujiFile || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shujiMusic" label="音频" prop="shujiMusic">
                        <file-upload
                                tip="点击上传音频"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.shujiMusic?ruleForm.shujiMusic:''"
                                @change="shujiMusicUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shujiMusic" label="音频" prop="shujiMusic">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.shujiMusic || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shujiFile: [
                              { required: true, message: '书籍文件不能为空', trigger: 'blur' },
                          ],
                   shujiMusic: [
