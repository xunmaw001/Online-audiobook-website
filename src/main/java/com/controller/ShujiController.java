    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        if(params.get("orderBy")==null || params.get("orderBy")==""){
            params.put("orderBy","shuji_clicknum");
        }
    ...
    */
    ...
    public R save(@RequestBody ShujiEntity shuji, HttpServletRequest request){
        ...
        Wrapper<ShujiEntity> queryWrapper = new EntityWrapper<ShujiEntity>()
            ...
            .eq("shuji_music", shuji.getShujiMusic())
...
//                            shujiEntity.setShujiTypes(Integer.valueOf(data.get(0)));   //书籍分类 要改的
//                            shujiEntity.setShujiFile(data.get(0));                    //书籍文件 要改的
//                            shujiEntity.setShujiMusic(data.get(0));                    //音频 要改的
